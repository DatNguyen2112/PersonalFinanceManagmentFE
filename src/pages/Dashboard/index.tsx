        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                    ...
                    <BarChart
                        data={transactionFacade.transactionDashboard?.cashFlow as any}
                        height={200}
                    />
                </div>
                ...
                <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-slate-100">
                    ...
                    <div className="divide-y divide-slate-50">
                        {transactionFacade.transactionDashboard?.recentTx?.length === 0 ? (
                            ...
                            transactionFacade.transactionDashboard?.recentTx?.map((txn: any) => (
                                <div
                                    key={txn.id}
                    ...
                    <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100">
                        ...
                        <div className="space-y-4">
                            {transactionFacade.transactionDashboard?.budgets?.length === 0 ? (
                                ...
                                transactionFacade.transactionDashboard?.budgets?.map((b: any) => (
                                    <div key={b.budgetId}>
