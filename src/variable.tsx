...
const wsUrl =
    ...
    String(import.meta.env.VITE_URL_API || '').replace('/api/v1', '/ws') ||
    'https://finance.pro.vn/ws';

/** Native WebSocket URL (wss://) — do not use SockJS (/ws/info handshake). */
export const linkWs = wsUrl.replace(/^http/, 'ws');